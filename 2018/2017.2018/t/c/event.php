...
if(date("Ymd", $timestamp) == 20170917) {
    if($timehi< 0900) {
        ...
        if($timehi>= 0900 and $timehi< 0930) {
            $event[0] = '[開始までお待ちください]';
            $event[1] = '';
        } elseif($timehi< 1000) {
            $event[0] = 'だんすのじかん';
        ...
        if($timehi>= 0900 and $timehi< 1100) {
            $event[2] = 'バスケ部招待試合';
            $event[3] = '09:00～11:00';
        } elseif($timehi< 1300) {
            $event[2] = '[開始までお待ちください]';
        ...
        if($timehi>= 0900 and $timehi< 0950) {
            $event[4] = '[開始までお待ちください]';
            $event[5] = '';
        } elseif($timehi< 1030) {
            $event[4] = 'Mr.question';
        ...
        if($timehi>= 0900 and $timehi< 1400) {
            $event[6] = '剣道大会';
            $event[7] = '09:00～14:00';
        } else {
            $event[6] = '[本日は終了しました]';
        ...
        if($timehi>= 0900 and $timehi< 1430) {
            $event[8] = '[開始までお待ちください]';
            $event[9] = '';
        } elseif($timehi< 1530) {
            $event[8] = 'PTAコーラス';
        ...
        if($timehi>= 0900 and $timehi< 1000) {
...
} elseif(date("Ymd", $timestamp) == 20170918) {
    if($timehi< 0900) {
        $event[0] = '[開場までお待ちください]';
        $event[2] = '[開場までお待ちください]';
        $event[4] = '[開場までお待ちください]';
        ...
        if($timehi>= 0900 and $timehi< 1300) {
            $event[2] = '[開始までお待ちください]';
            $event[3] = '';
        } elseif($timehi< 1400) {
            $event[2] = '吹奏楽部コンサート';
        ...
        if($timehi>= 0900 and $timehi< 1010) {
            $event[4] = '[開始までお待ちください]';
            $event[5] = '';
        } elseif($timehi< 1050) {
            $event[4] = '鶴の湯';
    ...
    $event[0] = '[開催日時のみ表示されます]';
    $event[2] = '[開催日時のみ表示されます]';
    $event[4] = '[開催日時のみ表示されます]';
    $event[6] = '[開催日時のみ表示されます]';
    $event[8] = '[開催日時のみ表示されます]';
    $event[10] = '[開催日時のみ表示されます]';
    $event[1] = '';
    $event[3] = '';
    $event[5] = '';
    $event[7] = '';
